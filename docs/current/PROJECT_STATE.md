...
## Current gate
TASK-511 is dependency-safe and READY. Execute only TASK-511. TASK-511 covers evidence-first Brownfield inventory/assimilation with provenance, owner/revision/currentness and `AI inference != authority`.
