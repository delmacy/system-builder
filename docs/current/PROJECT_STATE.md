...
`G2-WP-01`, `G2-WP-02`, `G2-WP-03` and `G2-WP-04` are CANONICALLY CLOSED. Fresh product base is `main@00748a312c78dcb726e3bbcde9d39ed8ff36debe`; pinned research authority remains `research/g2-capability-pipeline@2ef10187d691666b45cba5978671570f0ff90c2a`.
...
TASK-507 `historical/current reader-writer coexistence and population/currentness semantics` is INTEGRATED by PR #643. Exact head `75c85ba8af51fa9660070a694b215cd11d8468cb` passed Deterministic CI #1577, Heavy Product Tests #1137 and Automation Handoff #1749, merging as fresh `main@00748a312c78dcb726e3bbcde9d39ed8ff36debe`.
...
## Current gate
TASK-508 is the next dependency-safe product task. TASK-509 remains predecessor-gated. Construction B/C and later-package, concrete migration/runtime/provider, Production Readiness and unrelated DEFER/DO_NOT_BUILD scope remain NOT MATERIALIZED.