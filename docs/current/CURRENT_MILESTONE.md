...
Construction B materialization selects only `TASK-531 -> TASK-532 -> TASK-533 -> TASK-534`. TASK-531 is READY; TASK-532..534 remain predecessor-gated.

## Current gate
Integrate this bounded Construction B materialization after exact-head gates pass. Then rebuild fresh main and execute only TASK-531.
