...
Construction B materialization selects only `TASK-531 -> TASK-532 -> TASK-533 -> TASK-534`. Materialization PR #715 is integrated. TASK-531 is integrated by PR #716 as `main@875fadf1c874f5338c0099da663a4c3f0baf7ec2` after exact-head gates passed. TASK-532 is READY; TASK-533..534 remain predecessor-gated.

## Current gate
Integrate the bounded post-TASK-531 repository-memory reconciliation after exact-head gates pass. Then rebuild fresh main and execute only TASK-532.
