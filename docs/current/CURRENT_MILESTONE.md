...
## Current gate
Integrate this reconciliation only after exact-head gates pass, then execute TASK-525 from fresh main. Do not start TASK-526 before TASK-525 integration/reconciliation.
