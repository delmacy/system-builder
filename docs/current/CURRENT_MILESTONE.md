...
G2-WP-07 owns `G2-WBS-06`, `G2-WBS-08`, `G2-WBS-11`. Construction A `G2-DURABLE-EXECUTION-FOUNDATION-01` is materialized as `TASK-519 -> TASK-520 -> TASK-521 -> TASK-522`. TASK-519 is integrated by PR #682 on fresh `main@6a3d342847dc2e4160f52e2103c7f873e5c4b89f`; TASK-520 is READY; TASK-521..522 remain predecessor-gated.

## Current gate
Execute only TASK-520 after this post-TASK-519 repository-memory reconciliation is integrated. TASK-520 must preserve external-effect identity distinct from attempt/delivery identity, provider/API ACK distinct from business effect, authoritative reconcile-before-retry for unsafe UNKNOWN, explicit idempotency authority/scope/payload/horizon, and stale/revision/currentness fencing. Do not start TASK-521 before TASK-520 is integrated and repository memory is reconciled.
