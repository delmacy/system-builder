import systemDefinitionCanonicalSchema from "./system-definition.schema.json";
...
export const systemDefinitionSchema = Object.freeze(systemDefinitionCanonicalSchema);
