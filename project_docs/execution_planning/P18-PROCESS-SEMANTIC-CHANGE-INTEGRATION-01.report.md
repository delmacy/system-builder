...
- TASK-405: canonical predecessor/diff/classification/rationale evidence is bound to the EvolutionRequest references and mismatches fail closed.
...
- TASK-408 implementation/growing-proof exact-head gates are pending and must pass before lifecycle completion and Sprint Review.
