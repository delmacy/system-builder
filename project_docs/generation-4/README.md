...
1. **Product UX, Living Canvas & AI-Native Builder** — `research/G4_PRODUCT_UX_AI_NATIVE_BUILDER.md`; frontend/design-system foundation plan — `research/G4_FRONTEND_DESIGN_SYSTEM_FOUNDATION_PLAN.md`; interaction-state research — `research/G4_UI_INTERACTION_STATE_MATRIX_RESEARCH.md`
