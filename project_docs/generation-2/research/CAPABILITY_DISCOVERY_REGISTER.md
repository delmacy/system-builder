...
Prior cycle-7 candidates remain authoritative: applicability-scoped transition qualification, ambiguous transition effect reconciliation, mixed transition support vector and residual consumer/session/cache/subscription drainage.
