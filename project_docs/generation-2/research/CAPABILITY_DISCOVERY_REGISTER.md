...
|---|---|---|---|
| G2-CAPABILITY-CANDIDATE-SEMANTIC-EXTENSION-REALIZATION-BINDING | CROSS_CUTTING | CANDIDATE | Provider/Binding synthesis confirms a reusable semantic-requirement → selected-realization primitive rather than an Extension-local concept. |
