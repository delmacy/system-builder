...
`G2-FINDING-UCA-23..28` remain authoritative in the UCA dossier.

### Process & Application Modeling — revisit 3
`G2-FINDING-PAM-23..28` remain authoritative in the PAM dossier.

### UI / Generated Experience / Low-code Builder — revisit 3
`G2-FINDING-UIGX-23..28` remain authoritative in the UI dossier.

### Adaptive Governed Work Surfaces — revisit 2
`G2-FINDING-AGWS-16..21` remain authoritative in the AGWS dossier.

### Workflow & Durable Execution — revisit 3
`G2-FINDING-WDE-23..28` remain authoritative in the Workflow dossier.

### Integration & Automation — revisit 3
`G2-FINDING-IA-23..28` remain authoritative in the Integration dossier.

### Identity / Authentication / Federation — revisit 3
`G2-FINDING-IAF-23..28` remain authoritative in the Identity dossier.

### Authorization / Policy / Organization / Multitenancy — revisit 3
`G2-FINDING-AUTH-23..28` remain authoritative in the Authorization dossier.
...
`G2-FINDING-NEM-23..28` remain authoritative in the Notifications dossier.
