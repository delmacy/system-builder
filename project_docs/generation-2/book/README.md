...
A pesquisa adversarial continua `ACTIVE / NOT_SATURATED`; no snapshot editorial revalidado em 2026-09-06, Full Passes 1–7 estão completos e o Full Pass 8 está em 24/28 capabilities e 12/12 mandatory clusters, com 7/8 full passes mínimos completos e 408 findings materiais (284 edge scenarios + 124 ConflictPatterns). O revisit mais recente, Developer / Operator Experience / Self-hosting, foi `ELIGIBLE NO-NEW-MATERIAL`: revision-vector incompatibility, lacunas no recovery set, fechamento de dependências desconectado, pressão combinada de filas de manutenção e negócio, completude da evidência do operador, ownership gaps, readiness false-NA, procedimentos Brownfield e as lentes de Elicitation/Operability foram absorvidos pelas famílias já existentes. Isso reforça separações já ensinadas — procedimento disponível não prova que suas precondições continuam verdadeiras, operação observável não implica ownership completo, e readiness não deve ser inferida como não aplicável apenas porque uma evidência esperada está ausente —, mas **não constitui entendimento materialmente novo e não equivale ainda a saturação**. Elicitation & System Understanding e Operability Elicitation permanecem lentes transversais em pesquisa. A negative-space final ainda não começou e Planning C continua bloqueado. Por isso, capítulos publicados devem permanecer estáveis enquanto novos resultados apenas reconfirmarem padrões existentes; revisão de versão continua reservada a mudança material de compreensão.
